...
var $author$project$Editor$DeletionEffectData = F2(
	function (path, selection) {
		return {path: path, selection: selection};
	});
...
var $author$project$Editor$deletionEffect = function (nodeContext) {
	return $author$project$Editor$DeletionEffect(
		A2(
			$author$project$Editor$DeletionEffectData,
			$author$project$Structure$pathOf(nodeContext),
			$author$project$Editor$emptySelection));
};
...
var $author$project$Editor$Bold = {$: 'Bold'};
var $author$project$Editor$FontStyle = function (a) {
	return {$: 'FontStyle', a: a};
};
var $author$project$Editor$styleBold = $author$project$Editor$FontStyle($author$project$Editor$Bold);
var $author$project$Editor$Color = function (a) {
	return {$: 'Color', a: a};
};
var $author$project$Editor$styleTextColor = function (color) {
	return $author$project$Editor$Color(color);
};
var $author$project$Editor$StyleCell = function (a) {
	return {$: 'StyleCell', a: a};
};
var $author$project$Editor$roleStyles = $author$project$Structure$roleFromString('styles');
var $author$project$Editor$withStyle = function (style) {
	return A2(
		$author$project$Structure$addToCustom,
		$author$project$Editor$roleStyles,
		$author$project$Structure$createNode(
			$author$project$Editor$StyleCell(style)));
};
var $author$project$Statemachine$withKeywordStyle = A2(
	$elm$core$Basics$composeR,
	$author$project$Editor$withStyle($author$project$Editor$styleBold),
	$author$project$Editor$withStyle(
		$author$project$Editor$styleTextColor($avh4$elm_color$Color$darkBlue)));
...
var $author$project$Statemachine$editorEvents = function (sm) {
	...
	return A3(
		...
		A2(
			...
			$author$project$Statemachine$withKeywordStyle(
...
var $author$project$Statemachine$editorStatemachineName = function (sm) {
	return A3(
		...
		A2(
			$author$project$Editor$with,
			A2($author$project$Editor$inputCell, $author$project$Structure$roleName, sm),
			A2(
				$author$project$Editor$with,
				$author$project$Statemachine$withKeywordStyle(
...
var $author$project$Editor$buttonCell = function (text) {
	return A3(
		$author$project$Structure$addText,
		$author$project$Editor$roleText,
		text,
		$author$project$Structure$createNode(
...
var $author$project$Structure$addRangeToCustom = F3(
	function (role, children, parent) {
		return A3(
			$elm$core$List$foldl,
			$author$project$Structure$addToCustom(role),
			parent,
			children);
	});
...
var $author$project$Editor$CreateScopeEffectData = F3(
	function (isa, pathContextNode, scopeProvider) {
		return {isa: isa, pathContextNode: pathContextNode, scopeProvider: scopeProvider};
	});
var $author$project$Editor$createScopeEffect = F3(
	function (target, path, scopeProvider) {
...
var $author$project$Editor$refCell = F4(
	function (target, role, nodeContext, scopeProvider) {
		var pathContext = $author$project$Structure$pathOf(nodeContext);
		return A2(
			$author$project$Editor$withEffect,
			A3(
				$author$project$Editor$createScopeEffect,
				target,
				$author$project$Structure$pathOf(nodeContext),
				scopeProvider),
			A2(
				$author$project$Editor$withEffect,
				A2($author$project$Editor$inputEffect, pathContext, role),
				A3(
					$author$project$Structure$addRangeToCustom,
					$author$project$Editor$roleScope,
			...
			A2(
				...
				A2(
					...
					A2(
						...
						$author$project$Editor$addIndent($author$project$Editor$vertGridCell)),
					A2(
						$author$project$Editor$with,
...
var $author$project$Editor$edgeCell = F3(
	function (role, _v0, nodeContext) {
		var from = _v0.a;
		var to = _v0.b;
		return A3(
			$author$project$Structure$addText,
			$author$project$Editor$roleTo,
			to,
			A3(
				$author$project$Structure$addText,
				$author$project$Editor$roleFrom,
				from,
				A3(
					$author$project$Structure$addText,
					$author$project$Editor$roleText,
...
var $author$project$Editor$initGravityStrength = 150;
var $author$project$Editor$initGravityX = 400;
var $author$project$Editor$initGravityY = 300;
var $author$project$Editor$roleGravityStrength = $author$project$Structure$roleFromString('gravityStrength');
var $author$project$Editor$roleGravityX = $author$project$Structure$roleFromString('gravityX');
var $author$project$Editor$roleGravityY = $author$project$Structure$roleFromString('gravityY');
var $author$project$Editor$graphCell = A3(
	$author$project$Structure$addFloat,
	$author$project$Editor$roleGravityY,
	$author$project$Editor$initGravityY,
	A3(
		$author$project$Structure$addFloat,
		$author$project$Editor$roleGravityX,
		$author$project$Editor$initGravityX,
		A3(
			$author$project$Structure$addFloat,
			$author$project$Editor$roleGravityStrength,
			$author$project$Editor$initGravityStrength,
			$author$project$Structure$createNode(
...
var $author$project$Editor$roleCollapsible = $author$project$Structure$roleFromString('collapsible');
var $author$project$Editor$setCollapsible = function (cell) {
	var _v0 = $author$project$Structure$isaOf(cell);
	if ((_v0.$ === 'ContentCell') && (_v0.a.$ === 'StackCell')) {
		var _v1 = _v0.a;
		return A2($author$project$Structure$boolOf, $author$project$Editor$roleIsHoriz, cell) ? cell : A3($author$project$Structure$addBool, $author$project$Editor$roleCollapsible, true, cell);
	} else {
		return cell;
	}
};
...
var $author$project$Statemachine$editorStatemachine = function (sm) {
	return A2(
		...
		A2(
			$author$project$Editor$with,
			$author$project$Editor$setCollapsible(
				A2(
					$author$project$Editor$with,
...
var $author$project$Runtime$NormalView = {$: 'NormalView'};
...
var $author$project$Runtime$ToggleReflectiveView = {$: 'ToggleReflectiveView'};
...
var $author$project$Runtime$subscriptions = function (model) {
	...
	var hotkeySub = $elm$browser$Browser$Events$onKeyDown(
		A3(
			$elm$json$Json$Decode$map2,
			F2(
				function (key, alt) {
					return (alt && (key === 'r')) ? $author$project$Runtime$ToggleReflectiveView : $author$project$Runtime$EditorMsg($author$project$Editor$NoOp);
				}),
	...
	return $elm$core$Platform$Sub$batch(
		_Utils_ap(
			_List_fromArray(
				[hotkeySub, mouseMoveSub]),
			graphSubs));
};
var $author$project$Runtime$ReflectiveView = {$: 'ReflectiveView'};
var $author$project$Structure$customFeatures = function (_v0) {
	var features = _v0.a.features;
	return $elm$core$Dict$toList(features.custom);
};
...
var $author$project$Editor$ReflectiveEditor$withKeywordStyle = A2(
	$elm$core$Basics$composeR,
	$author$project$Editor$withStyle($author$project$Editor$styleBold),
	$author$project$Editor$withStyle(
		$author$project$Editor$styleTextColor($avh4$elm_color$Color$darkBlue)));
var $author$project$Editor$ReflectiveEditor$editorPath = function (tree) {
	return A3(
		$author$project$Editor$addMargin,
		$author$project$Editor$Bottom,
		15,
		$author$project$Editor$addIndent(
			A2(
				$author$project$Editor$with,
				$author$project$Editor$constantCell(
					$author$project$Structure$pathAsIdFromNode(tree)),
				A2(
					$author$project$Editor$with,
					A3(
						$author$project$Editor$addMargin,
						$author$project$Editor$Bottom,
						5,
						$author$project$Editor$ReflectiveEditor$withKeywordStyle(
							$author$project$Editor$constantCell('path:'))),
					$author$project$Editor$horizStackCell))));
};
...
var $author$project$Editor$ReflectiveEditor$withLabelStyle = $author$project$Editor$withStyle(
	$author$project$Editor$styleTextColor($avh4$elm_color$Color$darkGreen));
var $author$project$Editor$ReflectiveEditor$editorProperty = function (_v0) {
	var role = _v0.a;
	var primitive = _v0.b;
	return A3(
		$author$project$Editor$addMargin,
		...
		A2(
			$author$project$Editor$with,
			$author$project$Editor$constantCell(
				$author$project$Structure$primitiveToString(primitive)),
			A2(
				$author$project$Editor$with,
				$author$project$Editor$ReflectiveEditor$withLabelStyle(
					$author$project$Editor$constantCell(role + ':')),
				$author$project$Editor$horizStackCell)));
};
...
var $author$project$Structure$propertiesOf = function (node) {
	return $elm$core$Dict$toList(
		$author$project$Structure$propsOf(node));
};
var $avh4$elm_color$Color$darkGray = A4($avh4$elm_color$Color$RgbaSpace, 186 / 255, 189 / 255, 182 / 255, 1.0);
var $author$project$Editor$Italic = {$: 'Italic'};
var $author$project$Editor$styleItalic = $author$project$Editor$FontStyle($author$project$Editor$Italic);
var $author$project$Editor$ReflectiveEditor$withHintStyle = A2(
	$elm$core$Basics$composeR,
	$author$project$Editor$withStyle($author$project$Editor$styleItalic),
	$author$project$Editor$withStyle(
		$author$project$Editor$styleTextColor($avh4$elm_color$Color$darkGray)));
var $author$project$Editor$ReflectiveEditor$editorPropertyList = function (tree) {
	var editorPropertiesResult = function () {
		var _v0 = $author$project$Structure$propertiesOf(tree);
		if (!_v0.b) {
			return A3(
				$author$project$Editor$addMargin,
				$author$project$Editor$Bottom,
				15,
				$author$project$Editor$ReflectiveEditor$withHintStyle(
					$author$project$Editor$constantCell('<no properties>')));
		} else {
			var properties = _v0;
			return A2(
				$author$project$Editor$withRange,
				A2($elm$core$List$map, $author$project$Editor$ReflectiveEditor$editorProperty, properties),
				$author$project$Editor$vertGridCell);
		}
	}();
	return $author$project$Editor$addIndent(
		A2($author$project$Editor$with, editorPropertiesResult, $author$project$Editor$vertStackCell));
};
var $author$project$Editor$ReflectiveEditor$editorProperties = function (tree) {
	return $author$project$Editor$setCollapsible(
		A3(
			$author$project$Editor$addMargin,
			$author$project$Editor$Bottom,
			15,
			$author$project$Editor$addIndent(
				A2(
					$author$project$Editor$with,
					$author$project$Editor$ReflectiveEditor$editorPropertyList(tree),
					A2(
						$author$project$Editor$with,
						A3(
							$author$project$Editor$addMargin,
							...
							5,
							$author$project$Editor$ReflectiveEditor$withKeywordStyle(
								$author$project$Editor$constantCell('properties:'))),
						$author$project$Editor$vertStackCell)))));
};
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$Editor$ReflectiveEditor$editorCustomFeatures = function (tree) {
	var editorFeaturesResult = function () {
		var _v2 = $author$project$Structure$customFeatures(tree);
		if (!_v2.b) {
			return $author$project$Editor$ReflectiveEditor$withHintStyle(
				$author$project$Editor$constantCell('<no custom features>'));
		} else {
			var features = _v2;
			return A2(
				$author$project$Editor$withRange,
				A2($elm$core$List$map, $author$project$Editor$ReflectiveEditor$editorFeature, features),
				$author$project$Editor$vertStackCell);
		}
	}();
	return A2($author$project$Editor$with, editorFeaturesResult, $author$project$Editor$vertStackCell);
};
var $author$project$Editor$ReflectiveEditor$editorFeature = function (_v0) {
	var feature = _v0.a;
	var children = _v0.b;
	var editorChildren = function () {
		if (!children.b) {
			return $author$project$Editor$addIndent(
				A3(
					$author$project$Editor$addMargin,
					...
					15,
					$author$project$Editor$ReflectiveEditor$withHintStyle(
						$author$project$Editor$constantCell('<empty feature>'))));
		} else {
			return $author$project$Editor$addIndent(
				A3(
					$author$project$Editor$addMargin,
					...
					A2(
						$author$project$Editor$withRange,
						A2($elm$core$List$map, $author$project$Editor$ReflectiveEditor$editorTree, children),
						$author$project$Editor$vertStackCell)));
		}
	}();
	return $author$project$Editor$setCollapsible(
			...
			A2(
				...
				A2(
					...
					A3(
						...
						15,
						$author$project$Editor$ReflectiveEditor$withLabelStyle(
							$author$project$Editor$constantCell(feature + ':'))),
					$author$project$Editor$vertStackCell))));
};
var $author$project$Editor$ReflectiveEditor$editorFeatures = function (tree) {
	return $author$project$Editor$setCollapsible(
		A3(
			$author$project$Editor$addMargin,
			$author$project$Editor$Bottom,
			...
			$author$project$Editor$addIndent(
				A2(
					$author$project$Editor$with,
					$author$project$Editor$ReflectiveEditor$editorCustomFeatures(tree),
					A2(
						$author$project$Editor$with,
						$author$project$Editor$ReflectiveEditor$editorFeature(
							_Utils_Tuple2(
								'default',
								$author$project$Structure$getUnderDefault(tree))),
						A2(
							$author$project$Editor$with,
							A3(
								$author$project$Editor$addMargin,
								...
								5,
								$author$project$Editor$ReflectiveEditor$withKeywordStyle(
									$author$project$Editor$constantCell('features:'))),
							$author$project$Editor$vertStackCell))))));
};
var $author$project$Editor$ReflectiveEditor$editorTree = function (tree) {
	return $author$project$Editor$setCollapsible(
		A2(
			$author$project$Editor$with,
			$author$project$Editor$ReflectiveEditor$editorFeatures(tree),
			A2(
				$author$project$Editor$with,
				$author$project$Editor$ReflectiveEditor$editorProperties(tree),
				A2(
					$author$project$Editor$with,
					$author$project$Editor$ReflectiveEditor$editorPath(tree),
					A2(
						$author$project$Editor$with,
						A3(
							$author$project$Editor$addMargin,
							...
							$author$project$Editor$ReflectiveEditor$withKeywordStyle(
								$author$project$Editor$constantCell(
									'Node ' + $elm$core$Debug$toString(
										$author$project$Structure$isaOf(tree))))),
						$author$project$Editor$vertStackCell)))));
};
...
var $author$project$Editor$ReflectiveEditor$editorReflection = function (_v0) {
	var domainTree = _v0.a;
	var cellTree = _v0.b;
	var cellTreeContent = A2(
		$elm$core$Maybe$withDefault,
		$author$project$Editor$constantCell('nothing to render'),
		$elm$core$List$head(
			$author$project$Structure$getUnderDefault(cellTree)));
	return A2(
		$author$project$Editor$with,
		A2(
			$author$project$Editor$with,
		...
		F2(
			function (v, d) {
				return A3(
					...
					A2($author$project$Structure$textOf, $author$project$Editor$roleName, v),
					v,
					d);
			}),
		$elm$core$Dict$empty,
...
var $author$project$Editor$persistGravityInformation = F2(
	function (eRootOld, eRootNew) {
		var persistGravity = F2(
			function (gOld, rootNew) {
				var mbGravityY = A2($author$project$Structure$tryFloatOf, $author$project$Editor$roleGravityY, gOld);
				var mbGravityX = A2($author$project$Structure$tryFloatOf, $author$project$Editor$roleGravityX, gOld);
				var persistGravityPos = function (root) {
					var _v1 = _Utils_Tuple2(mbGravityX, mbGravityY);
					if (_v1.a.$ === 'Nothing') {
						var _v2 = _v1.a;
						return root;
					} else {
						if (_v1.b.$ === 'Nothing') {
							...
							return A3(
								...
								$author$project$Structure$pathOf(gOld),
								_Utils_Tuple2(
									$author$project$Editor$roleGravityY,
				...
				var mbGravityStrength = A2($author$project$Structure$tryFloatOf, $author$project$Editor$roleGravityStrength, gOld);
				var persistGravityStrength = function () {
					if (mbGravityStrength.$ === 'Nothing') {
						return rootNew;
					} else {
						var strength = mbGravityStrength.a;
						return A3(
							$author$project$Structure$updatePropertyByPath,
							$author$project$Structure$pathOf(gOld),
							_Utils_Tuple2(
								$author$project$Editor$roleGravityStrength,
								$author$project$Structure$asPFloat(strength)),
							rootNew);
					}
				}();
				return persistGravityPos(persistGravityStrength);
			});
		var graphsOld = A2(
			$author$project$Structure$nodesOf,
			$author$project$Editor$ContentCell($author$project$Editor$GraphCell),
			eRootOld);
		return A3($elm$core$List$foldl, persistGravity, eRootNew, graphsOld);
	});
...
var $author$project$Editor$persistGraphInformation = F2(
	function (eRootOld, eRootNew) {
		return A2(
			$author$project$Editor$persistGravityInformation,
			eRootOld,
			A2($author$project$Editor$persistVertexPositions, eRootOld, eRootNew));
	});
var $author$project$Editor$ResizeVertex = F2(
	function (a, b) {
		return {$: 'ResizeVertex', a: a, b: b};
	});
...
var $author$project$Editor$resizeCmd = function (root) {
	var vertices = A2(
		$author$project$Structure$nodesOf,
		$author$project$Editor$ContentCell($author$project$Editor$VertexCell),
		root);
	var toResizeCmd = F2(
		function (vertex, result) {
			if (result.$ === 'Ok') {
				...
				return A2($author$project$Editor$ResizeVertex, element, vertex);
			} else {
				return $author$project$Editor$NoOp;
			}
		});
	var cmdFromTuple = function (_v1) {
		var child = _v1.a;
		var v = _v1.b;
		return A2(
			...
			$elm$browser$Browser$Dom$getElement(
				$author$project$Structure$pathAsIdFromNode(child)));
	};
	var childAndVertex = function (v) {
		var _v0 = $elm$core$List$head(
			$author$project$Structure$getUnderDefault(v));
		if (_v0.$ === 'Nothing') {
			return $elm$core$Maybe$Nothing;
		} else {
			var child = _v0.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(child, v));
		}
	};
	return $elm$core$Platform$Cmd$batch(
		A2(
			...
			A2(
				...
				A2($elm$core$List$map, childAndVertex, vertices))));
};
...
var $author$project$Editor$roleHeight = $author$project$Structure$roleFromString('height');
var $author$project$Editor$roleHintGravity = $author$project$Structure$roleFromString('hintGravity');
var $author$project$Editor$roleMouseEnter = $author$project$Structure$roleFromString('mouseEnter');
var $author$project$Editor$roleShowGravity = $author$project$Structure$roleFromString('showGravity');
var $author$project$Editor$roleWidth = $author$project$Structure$roleFromString('width');
...
var $author$project$Editor$customEdgeForcesFromGraph = F2(
	function (cellGraph, distance) {
			...
			if (_v1.a.$ === 'Nothing') {
				...
				if (_v1.b.$ === 'Nothing') {
					...
					return _Utils_eq(source, target) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						{distance: distance, source: source, strength: $elm$core$Maybe$Nothing, target: target});
				}
			}
		};
		var edges = A2(
...
var $author$project$Editor$simulationFromGraph = function (graph) {
	var vertices = A2(
		$author$project$Structure$nodesOf,
		$author$project$Editor$ContentCell($author$project$Editor$VertexCell),
		graph);
	var gravityY = A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityY, graph);
	var gravityX = A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityX, graph);
	var forces = A2(
		$elm$core$List$cons,
		A2($gampleman$elm_visualization$Force$center, gravityX, gravityY),
		_List_fromArray(
			[
				A2(
				...
				1,
				A2(
					$author$project$Editor$customEdgeForcesFromGraph,
					graph,
					A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityStrength, graph))),
				A2(
...
var $author$project$Editor$tickGraphSimulations = function (editorModel) {
	...
	if (mbCellGraph.$ === 'Nothing') {
		...
		var graph = mbCellGraph.a;
		var _v1 = editorModel.mbSimulation;
		if (_v1.$ === 'Nothing') {
			var simulation = $author$project$Editor$simulationFromGraph(graph);
			return _Utils_Tuple2(
				_Utils_update(
					editorModel,
					{
						mbSimulation: $elm$core$Maybe$Just(simulation),
						runXform: false
					}),
				$author$project$Editor$resizeCmd(editorModel.eRoot));
		} else {
			var simulation = _v1.a;
			var vertices = A2(
				$author$project$Structure$nodesOf,
				$author$project$Editor$ContentCell($author$project$Editor$VertexCell),
				graph);
			var pathToGraph = $author$project$Structure$pathOf(graph);
			var entities = A2(
			...
			var childrenNew = _Utils_ap(
				...
				edges);
			var cellGraphNew = A3($author$project$Structure$replaceUnderFeature, $author$project$Editor$roleDefault, childrenNew, graph);
...
var $author$project$Editor$updateOnEnterEffect = F3(
	function (editorModel, effect, cellContext) {
		switch (effect.$) {
			...
			case 'SetPropertyEffect':
				var pathContextNode = effect.a.pathContextNode;
				var role = effect.a.role;
				var primitive = effect.a.primitive;
				var dRootNew = A3(
					$author$project$Structure$updatePropertyByPath,
					pathContextNode,
					_Utils_Tuple2(role, primitive),
					editorModel.dRoot);
				return _Utils_Tuple2(
					_Utils_update(
						editorModel,
...
var $author$project$Editor$updateOnManipulateGravity = F2(
	function (editorModel, manipulationData) {
		var mbGraphCell = A2($author$project$Structure$nodeAt, editorModel.eRoot, manipulationData.path);
		if (mbGraphCell.$ === 'Nothing') {
			return $author$project$Editor$noUpdate(editorModel);
		} else {
			var graph = mbGraphCell.a;
			var gravityStrengthNew = A3(
				$elm$core$Basics$clamp,
				50,
				600,
				function () {
					var _v3 = manipulationData.manipulationKind;
					if (_v3.$ === 'Increase') {
						return A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityStrength, graph) + 10;
					} else {
						return A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityStrength, graph) - 10;
					}
				}());
			var eRootNew = A3(
				$author$project$Structure$updatePropertyByPath,
				manipulationData.path,
				_Utils_Tuple2(
					$author$project$Editor$roleGravityStrength,
					$author$project$Structure$asPFloat(gravityStrengthNew)),
				editorModel.eRoot);
			var _v1 = function () {
				var _v2 = editorModel.mbSimulation;
				if (_v2.$ === 'Nothing') {
					...
					return _Utils_Tuple2(
						false,
						$elm$core$Maybe$Just(
							$author$project$Editor$simulationFromGraph(graph)));
				}
			}();
			var runSimulationNew = _v1.a;
			var mbSimulationNew = _v1.b;
			return _Utils_Tuple2(
				_Utils_update(
					editorModel,
					{eRoot: eRootNew, mbSimulation: mbSimulationNew, runSimulation: runSimulationNew}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Editor$updateOnShowGravity = F3(
	function (editorModel, role, showGravityData) {
		var eRootNew = A3(
			$author$project$Structure$updatePropertyByPath,
			showGravityData.path,
			_Utils_Tuple2(
				role,
				$author$project$Structure$asPBool(showGravityData.doShow)),
			editorModel.eRoot);
		return _Utils_Tuple2(
			_Utils_update(
				editorModel,
...
var $author$project$Editor$roleCollapsed = $author$project$Structure$roleFromString('collapsed');
var $author$project$Editor$updateOnToggleCollapsed = F2(
	function (editorModel, path) {
		var mbNodeToToggle = A2($author$project$Structure$nodeAt, editorModel.eRoot, path);
		if (mbNodeToToggle.$ === 'Nothing') {
			return $author$project$Editor$noUpdate(editorModel);
		} else {
			var nodeToToggle = mbNodeToToggle.a;
			var toggleTo = !A2($author$project$Structure$boolOf, $author$project$Editor$roleCollapsed, nodeToToggle);
			var eRootNew = A3(
				$author$project$Structure$updatePropertyByPath,
				path,
				_Utils_Tuple2(
					$author$project$Editor$roleCollapsed,
					$author$project$Structure$asPBool(toggleTo)),
				editorModel.eRoot);
			return _Utils_Tuple2(
				_Utils_update(
					editorModel,
		...
		switch (msg.$) {
			case 'ResizeVertex':
				...
				var eRootNew = A3(
					...
					_Utils_Tuple2(
						$author$project$Editor$roleHeight,
						$author$project$Structure$asPFloat(element.element.height)),
					A3(
						$author$project$Structure$updatePropertyByPath,
						$author$project$Structure$pathOf(vertex),
						_Utils_Tuple2(
							$author$project$Editor$roleWidth,
							$author$project$Structure$asPFloat(element.element.width)),
						editorModel.eRoot));
				return _Utils_Tuple2(
					_Utils_update(
						editorModel,
						{eRoot: eRootNew, runXform: false}),
					$elm$core$Platform$Cmd$none);
			case 'Tick':
			...
			case 'OnEnter':
				...
				return A3($author$project$Editor$updateOnEnterEffect, editorModel, effect, cellContext);
			case 'OnClick':
				var effect = msg.a;
				var cellContext = msg.b;
				return A3($author$project$Editor$updateOnEnterEffect, editorModel, effect, cellContext);
			...
			case 'ShowGravity':
				var showGravityData = msg.a;
				return A3($author$project$Editor$updateOnShowGravity, editorModel, $author$project$Editor$roleShowGravity, showGravityData);
			case 'HintGravity':
				var showGravityData = msg.a;
				return A3($author$project$Editor$updateOnShowGravity, editorModel, $author$project$Editor$roleHintGravity, showGravityData);
			case 'ManipulateGravity':
				var manipulationData = msg.a;
				return A2($author$project$Editor$updateOnManipulateGravity, editorModel, manipulationData);
			default:
				var path = msg.a;
				return A2($author$project$Editor$updateOnToggleCollapsed, editorModel, path);
		}
	});
var $author$project$Runtime$update = F2(
	function (msg, model) {
		...
		var updateEditorOnly = function (eMsg) {
			var _v6 = A2($author$project$Editor$updateEditor, eMsg, editorModel);
			var editorModelUpdated = _v6.a;
			var editorCmd = _v6.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
		...
		switch (msg.$) {
			...
			case 'MouseUp':
				var eMsg = msg.a;
				return updateEditorOnly(eMsg);
			case 'ToggleReflectiveView':
				var kViewNew = function () {
					var _v2 = model.kView;
					if (_v2.$ === 'NormalView') {
						return $author$project$Runtime$ReflectiveView;
					} else {
						return $author$project$Runtime$NormalView;
					}
				}();
				var eRootNew = function () {
					if (kViewNew.$ === 'NormalView') {
						return A2(
							$author$project$Editor$persistGraphInformation,
							editorModel.eRoot,
							$author$project$Runtime$runDomainXform(domain));
					} else {
						return $author$project$Structure$updatePaths(
							$author$project$Editor$ReflectiveEditor$editorReflection(
								_Utils_Tuple2(model.editorModel.dRoot, model.editorModel.eRoot)));
					}
				}();
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editorModel: editorModelNew, kView: kViewNew}),
					$elm$core$Platform$Cmd$none);
			default:
				var eMsg = msg.a;
				var updateSimul = F2(
				...
				var _v4 = function () {
					if (editorModelUpdated.runXform) {
						...
						var eRootForDomain = A2(
							$author$project$Editor$persistGraphInformation,
							editorModelUpdated.eRoot,
							$author$project$Runtime$runDomainXform(domainNew));
						var rootENew = function () {
							var _v5 = model.kView;
							if (_v5.$ === 'NormalView') {
								return eRootForDomain;
							} else {
								return $author$project$Structure$updatePaths(
									$author$project$Editor$ReflectiveEditor$editorReflection(
										_Utils_Tuple2(editorModelUpdated.dRoot, eRootForDomain)));
							}
						}();
						...
						return _Utils_Tuple2(
							...
							$author$project$Editor$resizeCmd(editorModelNew.eRoot));
					} else {
						var mbSimulNew = A2(
							$elm$core$Maybe$andThen,
							updateSimul(false),
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($elm$core$Platform$Cmd$map, $author$project$Runtime$EditorMsg, editorCmd),
								A2($elm$core$Platform$Cmd$map, $author$project$Runtime$EditorMsg, resizeCmds)
							])));
		}
	});
...
var $author$project$Editor$HintGravity = function (a) {
	return {$: 'HintGravity', a: a};
};
var $elm_community$typed_svg$TypedSvg$Types$Paint = function (a) {
	return {$: 'Paint', a: a};
};
var $author$project$Editor$ToggleCollapsed = function (a) {
	return {$: 'ToggleCollapsed', a: a};
};
...
var $author$project$Editor$colorGravityPrimary = A4($avh4$elm_color$Color$rgba, 1.0, 0, 0, 0.5);
...
var $author$project$Editor$roleSeparator = $author$project$Structure$roleFromString('separator');
...
var $author$project$Editor$styleSplitBottom = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'display', 'table-row'),
		A2($elm$html$Html$Attributes$style, 'height', '48%'),
		A2($elm$html$Html$Attributes$style, 'border-top', '2px solid'),
...
var $author$project$Editor$vertexDragHandle = F2(
	function (cell, _v0) {
		...
		return A2($elm_community$typed_svg$TypedSvg$circle, attributes, _List_Nil);
	});
var $elm$core$Basics$atan2 = _Basics_atan2;
var $author$project$Editor$vertexProperties = function (vertex) {
	var widthVertex = A2($author$project$Structure$floatOf, $author$project$Editor$roleWidth, vertex) + 20;
	var heightVertex = A2($author$project$Structure$floatOf, $author$project$Editor$roleHeight, vertex) + 20;
	...
	return {angleAreas: angleAreas, heightVertex: heightVertex, posContent: posContent, posVertex: posVertex, widthVertex: widthVertex};
};
...
var $author$project$Editor$viewEmpty = $elm$html$Html$text('');
...
var $author$project$Editor$attributeFromStyle = function (styleCell) {
	if (styleCell.$ === 'StyleCell') {
		var style = styleCell.a;
		if (style.$ === 'FontStyle') {
			var fontStyle = style.a;
			switch (fontStyle.$) {
				case 'Regular':
					return _List_fromArray(
						[
...
var $author$project$Editor$styleAttributesFromCell = function (cell) {
	var styles = A2($author$project$Structure$isasUnderCustom, $author$project$Editor$roleStyles, cell);
	return $elm$core$List$concat(
		A2($elm$core$List$map, $author$project$Editor$attributeFromStyle, styles));
};
					...
					[
						...
						_Utils_ap(
							A2(
								...
								$author$project$Editor$styleAttributesFromCell(cell)),
							$author$project$Editor$marginsAndPaddings(cell)),
						_List_fromArray(
							[
								$elm$html$Html$text(
...
var $author$project$Editor$ShowGravity = function (a) {
	return {$: 'ShowGravity', a: a};
};
var $elm$core$Basics$abs = function (n) {
	return (n < 0) ? (-n) : n;
};
var $author$project$Editor$Decrease = {$: 'Decrease'};
var $author$project$Editor$Increase = {$: 'Increase'};
var $author$project$Editor$ManipulateGravity = function (a) {
	return {$: 'ManipulateGravity', a: a};
};
var $author$project$Editor$decodeMouseEvent = function (path) {
	return A2(
		$elm$json$Json$Decode$map,
		function (dY) {
			return $author$project$Editor$ManipulateGravity(
				{
					manipulationKind: (dY < 0) ? $author$project$Editor$Decrease : $author$project$Editor$Increase,
					path: path
				});
		},
...
var $author$project$Editor$viewGravity = function (cellGraph) {
	var radius = $elm$core$Basics$abs(
		A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityStrength, cellGraph)) / 2;
	var path = $author$project$Structure$pathOf(cellGraph);
	var onMouseOut = $elm$svg$Svg$Events$onMouseOut(
		$author$project$Editor$ShowGravity(
			{
				doShow: false,
				path: $author$project$Structure$pathOf(cellGraph)
			}));
	return A2($author$project$Structure$boolOf, $author$project$Editor$roleShowGravity, cellGraph) ? A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$r(radius),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$cx(
				A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityX, cellGraph)),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$cy(
				A2($author$project$Structure$floatOf, $author$project$Editor$roleGravityY, cellGraph)),
				...
				$elm$svg$Svg$Events$on,
				'mousewheel',
				$author$project$Editor$decodeMouseEvent(path)),
				onMouseOut,
				A2($author$project$Editor$gravityOnMouseMove, $author$project$Editor$ShowGravity, path)
			]),
		_List_Nil) : A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Types$Paint($author$project$Editor$colorGravityPrimary)),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(2),
				$elm_community$typed_svg$TypedSvg$Attributes$strokeDasharray('4'),
				$elm_community$typed_svg$TypedSvg$Attributes$fill(
...
var $author$project$Editor$PropertyEffectGroup = function (a) {
	return {$: 'PropertyEffectGroup', a: a};
};
		...
		function (k, v, effectGroupList) {
			switch (k) {
				...
				case 'property':
					return A2(
						$elm$core$List$cons,
						$author$project$Editor$PropertyEffectGroup(v),
						effectGroupList);
				default:
...
var $author$project$Editor$viewInputCell = function (cell) {
	...
	switch (_v0.$) {
		case 'ContentCell':
			...
			var inputSize = (inputValue === '') ? ($elm$core$String$length('<no value>') - 1) : ($elm$core$String$length(inputValue) - 1);
			return A2(
				$elm$html$Html$div,
				$author$project$Editor$divCellAttributes(cell),
				_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Attributes$InPx$width(widthVertex - 20),
					$elm_community$typed_svg$TypedSvg$Attributes$InPx$height(heightVertex - 20)
				]),
				...
				if (!_v15.b) {
					...
					if (_v16.$ === 'Nothing') {
						...
						return A2(
							...
							A3($elm$core$List$foldl, $author$project$Editor$viewContent, _List_Nil, children));
					}
				}
			} else {
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Editor$ToggleCollapsed(
											$author$project$Structure$pathOf(cell)))
									]),
								_Utils_ap(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													...
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$cx(6),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$cy(6),
											...
											_List_fromArray(
												[
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$x1(3),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$y1(6),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$x2(9),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$y2(6),
													$elm_community$typed_svg$TypedSvg$Attributes$stroke(
													$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$darkBlue))
												]),
											_List_Nil)
										]),
									A2($author$project$Structure$boolOf, $author$project$Editor$roleCollapsed, cell) ? _List_fromArray(
										[
											A2(
											$elm_community$typed_svg$TypedSvg$line,
											_List_fromArray(
												[
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$x1(6),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$y1(3),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$x2(6),
													$elm_community$typed_svg$TypedSvg$Attributes$InPx$y2(9),
													$elm_community$typed_svg$TypedSvg$Attributes$stroke(
													$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$darkBlue))
												]),
											_List_Nil)
...
var $author$project$Editor$viewGraphCell = function (cellGraph) {
	var hintGravity = A2($author$project$Structure$boolOf, $author$project$Editor$roleHintGravity, cellGraph);
	var gravity = hintGravity ? _List_fromArray(
		[
			A2(
			$elm_community$typed_svg$TypedSvg$g,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Editor$viewGravity(cellGraph)
				])),
			A2(
			$elm_community$typed_svg$TypedSvg$g,
			_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
				$author$project$Editor$gravityOnMouseMove,
				$author$project$Editor$HintGravity,
				$author$project$Structure$pathOf(cellGraph))
			]),
		_Utils_ap(
			_List_fromArray(
				[
	...
	switch (_v6.$) {
		case 'ContentCell':
			...
			return A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$div, $author$project$Editor$styleSplitTop, top),
						A2($elm$html$Html$div, $author$project$Editor$styleSplitBottom, bottom)
					]));
		case 'EffectCell':
			return $author$project$Editor$viewEmpty;
		default:
...
var $author$project$Editor$viewVertStackCell = function (cell) {
	...
	switch (_v0.$) {
		case 'ContentCell':
			return A2($author$project$Structure$boolOf, $author$project$Editor$roleCollapsible, cell) ? $author$project$Editor$viewCollapsibleVertStackCell(cell) : A2(
				$elm$html$Html$div,
				_Utils_ap(
					_List_fromArray(
						[
...
var $author$project$Runtime$projection = F2(
	function (dRoot, xform) {
		...
		var initialModel = {
			...
			kView: $author$project$Runtime$NormalView
		};
