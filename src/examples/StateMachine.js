...
var author$project$Main$ctorEvent = A3(
	author$project$Structure$addText,
	'name',
	'',
	author$project$Structure$createNode(author$project$Main$Event));
var author$project$Main$editorEvent = function (event) {
	return A2(
		author$project$Editor$withEffect,
		author$project$Editor$deletionEffect(event),
		A2(
			author$project$Editor$withEffect,
			A2(author$project$Editor$insertionEffect, event, author$project$Main$ctorEvent),
...
var author$project$Main$editorEventPlaceholder = function (sm) {
	return A2(
		author$project$Editor$withEffect,
		A3(author$project$Editor$replacementEffect, 'events', sm, author$project$Main$ctorEvent),
...
var author$project$Main$editorEvents = function (sm) {
	var editorEventsResult = function () {
		var _n0 = A2(author$project$Structure$getUnderCustom, 'events', sm);
		if (!_n0.b) {
			return _List_fromArray(
				[
					author$project$Main$editorEventPlaceholder(sm)
				]);
		} else {
			var events = _n0;
			return A2(elm$core$List$map, author$project$Main$editorEvent, events);
		}
	}();
	return A3(
...
var author$project$Editor$horizStackCell = A3(
	...
	author$project$Structure$createNode(
		author$project$Editor$ContentCell(author$project$Editor$StackCell)));
var author$project$Main$editorStateMachineName = function (sm) {
	return A3(
		author$project$Editor$addMargin,
		author$project$Editor$Bottom,
		20,
...
var author$project$Main$State = {$: 'State'};
var author$project$Main$ctorState = A3(
	author$project$Structure$addText,
	'name',
	'',
	author$project$Structure$createNode(author$project$Main$State));
var author$project$Main$editorStateHead = function (state) {
	return A2(
		author$project$Editor$with,
		A2(
			author$project$Editor$withEffect,
			...
			A2(
				author$project$Editor$withEffect,
				A2(author$project$Editor$insertionEffect, state, author$project$Main$ctorState),
...
var author$project$Main$editorTransitionPlaceholder = function (state) {
	return A2(
		author$project$Editor$withEffect,
		A3(author$project$Editor$replacementEffect, '', state, author$project$Main$ctorTransition),
...
var author$project$Main$editorState = function (state) {
	var editorTransitionsResult = function () {
		var _n0 = author$project$Structure$getUnderDefault(state);
		if (!_n0.b) {
			return _List_fromArray(
				[
					author$project$Main$editorTransitionPlaceholder(state)
				]);
		} else {
			var transitions = _n0;
			return A2(elm$core$List$map, author$project$Main$editorTransition, transitions);
		}
	}();
	return A3(
		author$project$Editor$addMargin,
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						author$project$Editor$with,
						author$project$Main$editorStateHead(state),
						author$project$Editor$vertStackCell)))));
};
var author$project$Main$editorStatesPlaceholder = function (sm) {
	return A2(
		author$project$Editor$withEffect,
		A3(author$project$Editor$replacementEffect, '', sm, author$project$Main$ctorState),
		author$project$Editor$placeholderCell('no states'));
};
var author$project$Main$editorStates = function (sm) {
	var editorStatesResult = function () {
		var _n0 = author$project$Structure$getUnderDefault(sm);
		if (!_n0.b) {
			return _List_fromArray(
				[
					author$project$Main$editorStatesPlaceholder(sm)
				]);
		} else {
			var states = _n0;
			return A2(elm$core$List$map, author$project$Main$editorState, states);
		}
	}();
...
var author$project$Editor$initEditorModel = F2(
	function (dRoot, eRoot) {
		return {dRoot: dRoot, eRoot: eRoot, mbSimulation: elm$core$Maybe$Nothing};
	});
...
var author$project$Runtime$subscriptions = function (model) {
	var _n0 = model.editorModel.mbSimulation;
	if (_n0.$ === 'Just') {
...
var author$project$Editor$tickGraphSimulations = function (editorModel) {
	...
	if (mbCellGraph.$ === 'Nothing') {
		...
		var _n1 = editorModel.mbSimulation;
		if (_n1.$ === 'Nothing') {
			var verticies = A2(
				author$project$Structure$nodesOf,
				author$project$Editor$ContentCell(author$project$Editor$VertexCell),
			...
			var _n2 = A2(
				...
				A2(
					...
					verticies));
			var newSimulationState = _n2.a;
			var verticiesNew = _n2.b;
...
var author$project$Editor$tryDelete = F5(
	function (editorModel, _n0, navFun, textLength, isAtDeletePos) {
		var path = _n0.path;
		if (!textLength) {
			return _Utils_Tuple3(
				true,
...
var author$project$Runtime$update = F2(
	function (msg, model) {
		...
		if (msg.$ === 'Tick') {
			var eMsg = msg.a;
			var _n1 = A2(author$project$Editor$updateEditor, eMsg, editorModel);
			var runXform = _n1.a;
			var editorModelUpdated = _n1.b;
			var editorCmd = _n1.c;
			return _Utils_Tuple2(
				_Utils_update(
					model,
			...
			var eMsg = msg.a;
			var _n2 = A2(author$project$Editor$updateEditor, eMsg, editorModel);
			var runXform = _n2.a;
			var editorModelUpdated = _n2.b;
			var editorCmd = _n2.c;
...
var author$project$Editor$paddings = function (_n0) {
...
var author$project$Main$main = A2(author$project$Runtime$projection, author$project$Main$initStateMachine, author$project$Main$editor);
